...
#define SDA_DIR_OUT_OLED    DIR_OLED  |= BIT2     //数据端口方向设为输出   SDA
#define SDA_DIR_IN_OLED     DIR_OLED  &= ~BIT2    //数据端口方向设为输入
#define SDA_I2C_H_OLED      PORT_OLED  |= BIT2
#define SDA_I2C_L_OLED      PORT_OLED  &= ~BIT2
