...
__interrupt void Port_1 (void)
{
    ...
    if((P1IN&0xff)!=0xff){
     temp1=P1IFG;
     P1IFG=0x00;
     if(temp1==0x02){UartPutchar('1');}//P1.1被按下
...
__interrupt void Port_2 (void)
{
    ...
    {temp2=P2IFG;
     P2IFG=0x00;
     if(temp2==0x02){ UartPutchar('2');
     GPIO_setOutputHighOnPin(GPIO_PORT_P4,GPIO_PIN7);}//P2.1被按下
    }
...
{   unsigned int counter=0;
    ...
    switch (__even_in_range(UCA0IV,4)){
        ...
        case 2:
            ...
            if(receivedData=='1'){GPIO_toggleOutputOnPin(GPIO_PORT_P1,GPIO_PIN0);}
            if(receivedData=='2'){GPIO_toggleOutputOnPin  (GPIO_PORT_P4,GPIO_PIN7);}
