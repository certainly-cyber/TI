...
#define OLED_SCLK_Clr() P6OUT&=~BIT0//CLK-D0
#define OLED_SCLK_Set() P6OUT|=BIT0

#define OLED_SDIN_Clr() P6OUT&=~BIT1//DIN-D1
#define OLED_SDIN_Set() P6OUT|=BIT1

#define OLED_RST_Clr() P6OUT&=~BIT2//RES
#define OLED_RST_Set() P6OUT|=BIT2

#define OLED_DC_Clr() P6OUT&=~BIT3//DC
#define OLED_DC_Set() P6OUT|=BIT3

#define OLED_CS_Clr()  P6OUT&=~BIT4//CS无
#define OLED_CS_Set()  P6OUT|=BIT4
...
#define OLED_RST_Clr() P3OUT&=~BIT0//RES
#define OLED_RST_Set() P3OUT|=BIT0

#define OLED_DC_Clr() P3OUT&=~BIT1//DC
#define OLED_DC_Set() P3OUT|=BIT1

#define OLED_CS_Clr()  P3OUT&=~BIT7//CS
#define OLED_CS_Set()  P3OUT|=BIT7
*/
